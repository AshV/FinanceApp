...
<html>
  <head>
    ...
    <title>Aqua_Arise | Add CSC</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Add New CSC</li>
          </ol>
        </section>
<!-- Main content -->
            ...
            <div class="box box-primary">
                ...
                <form role="form">
                  <div class="box-body">
					...
					<div class="form-group">
                      <label for="exampleInputEmail1">Branch Opening Date</label>
                      <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                    </div>
                    <div class="form-group">
			 ...
			 <div class="col-md-6">
              <!-- Horizontal Form -->
			   ...
			   <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Branch Contact Detail</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form">
                  <div class="box-body">
